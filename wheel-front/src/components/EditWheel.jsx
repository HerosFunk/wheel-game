...
const EditWheel = () => {
	...
	return (
		<div className="WheelDetails">
			...
			{errorMessage && (
				<div
					className="wheel-info-card"
					style={{ background: "linear-gradient(135deg, #e74c3c, #c0392b)", marginBottom: "24px" }}
				>
			...
			<div className="elements-list">
				...
				<div style={{ display: "flex", gap: "12px", alignItems: "center", marginBottom: "20px", flexWrap: "wrap" }}>
					...
					/>
					<button onClick={handleAddSegment} className="control-button" style={{ whiteSpace: "nowrap" }}>
						Add Element
					</button>
				</div>
			...
			<div className="elements-list">
				<div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px" }}>
					...
					<button onClick={setAllElementsActive} className="control-button">
						Activate All
					</button>
				</div>
								...
								>
									...
									<button
										...
										style={{
											...
											fontSize: "0.8rem",
											cursor:
												editingIndex === index || (segment.id && segment.id.toString().startsWith("temp_"))
													? "not-allowed"
													: "pointer",
											opacity:
												editingIndex === index || (segment.id && segment.id.toString().startsWith("temp_")) ? 0.5 : 1,
											width: "100%",
										}}
										title={
											segment.id && segment.id.toString().startsWith("temp_")
												? "Save the wheel first to activate/deactivate this element"
												: ""
										}
									>
